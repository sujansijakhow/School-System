            ...
            <div className='bg-white flex p-2 md:p-5'>
                <div className='flex'>
                    ...
                    <div className='flex flex-col gap-4 ml-2 md:ml-57'>
                        ...
                        <div className='flex flex-col gap-4 p-4 rounded-md bg-[#D9D9D9] w-full'>
                            <div className='w-full flex flex-col gap-4'>
                                <h1 className='font-bold text-md'>Help Center</h1>

                                <div className='flex flex-col gap-2 text-[17px] w-[40%] ml-88 mt-'>
                                    <h1 className='text- font-bold text-center'>Frequently Asked Questions</h1>
                                ...
                                <h1 className='font-bold text-sm mt-8'>Quick Help</h1>
